...
%%% Essentials
\name{Dheeraj}{Pille}
\mobile{(+1) 647-894-6119}
%%% Social
\email{dheerajpille@gmail.com}
\homepage{dheerajpille.github.io}
\github{dheerajpille}
\linkedin{dheerajpille}
\position{4A Computer Science student at the University of Waterloo}
%{\enskip\cdotp\enskip}DevOps Engineer
...
%%% \makecvfooter
%%%   {\today}
%%%   {Dheeraj Pille{\enskip\cdotp\enskip}Résumé}
%%%   {\thepage}
